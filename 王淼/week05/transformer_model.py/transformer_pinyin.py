...
# ─────────────────────────── Transformer 模型 ───────────────────────────
# 【这里全部重写，变成单向 Transformer】

class PositionalEncoding(nn.Module):
    """Transformer 必须的位置编码，告诉模型词的顺序"""
...
class TransformerLM(nn.Module):
    def __init__(
        ...
        # 2. Transformer 编码器层（单向 = 加 causal mask）
