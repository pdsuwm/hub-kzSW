...
import compat_fix  # noqa: F401  必须先于 trl 导入，修复 trl 0.21 + transformers 5.x 兼容
from trl import GRPOConfig, GRPOTrainer

from eval_math import SYSTEM_PROMPT, make_problem, parse_output
...
# 训练集难度配比：L4 混合运算为主，L5 乘法 + L2 加减保底
# L1/L3/L6 不进训练集，留作泛化评估
LEVEL_MIX = [
    ("L4_mixed_2step", 0.50),
